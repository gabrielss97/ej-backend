...
userController.newUser = (req, res) => {
    ...
    if(req.body.username && req.body.password) {
        if(req.body.password2 && req.body.password == req.body.password2) {
            ...
            .then(user => {
                ...
                if(user) {
                    ...
                    .then(hash => {
                        ...
                        newUser.save()
                        .then( () => res.json({ success:true, message: "Conta criada com sucesso", statusCode: 201}))
            ...
            res.json({ success: false, message: 'Confirmação de senha incorreta', statusCode:400});
        }
    } else {
